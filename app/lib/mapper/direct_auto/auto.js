...
module.exports = class Auto extends Base {
    ...
    insuranceInfo() {
        ...
        insurance_info.CurrentlyInsured = this.getParam('currently_insured').toLowerCase() === 'yes' ? 'Yes' : 'Uninsured';
        if (this.getParam('currently_insured').toLowerCase() === 'yes') {
            ...
            insurance_info.PolicyExpirationDt = this.getParam('expiration_date')
        } else {
        ...
        insurance_info.RequestedStartDt = this.getParam('expiration_date')
