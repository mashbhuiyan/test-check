const Auto = require('../verified_car_insurance/auto');
const Home = require('../verified_car_insurance/home');
const Health = require('../verified_car_insurance/health');
const Life = require('../verified_car_insurance/life');
const Medicare = require('../verified_car_insurance/medicare');
